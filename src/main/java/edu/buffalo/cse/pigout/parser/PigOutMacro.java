...
class PigOutMacro {
    ...
    private static final Log LOG = LogFactory.getLog(PigOutMacro.class);
    ...
    private Map<String, PigOutMacro> seen;
    ...
    PigOutMacro(String name, String file, List<String> params,
            List<String> returns, String body, Map<String, PigOutMacro> seen) {
        this.name = name;
    ...
    private CommonTree maskAlias(String in, Set<String> masks, CommonTree tree,
        ...
        for (CommonTree t : inlineNodes) {
            CommonTree newTree = macroInline(t,
                    new ArrayList<PigOutMacro>(seen.values()), macroStack, pigContext);
    ...
    */
    ...
    static CommonTree macroInline(CommonTree t,
                                  List<PigOutMacro> macroDefs, Set<String> macroStack,
        ...
        // get macroDef
        PigOutMacro macro = null;
        for (PigOutMacro pm : macroDefs) {
